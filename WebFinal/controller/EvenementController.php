...
class EvenementController {
    ...
    public function ajouterEvenement(Evenement $evenement) {
        ...
        $sql = "INSERT INTO evenement (titre, description, categorie, date, lieu, idorganisateur, image,nbplace)
                VALUES (:titre, :description, :categorie, :date, :lieu, :idorganisateur, :image, :nbplace)";
        $req = $db->prepare($sql);
        $req->execute([
    ...
    public function modifierEvenement($id, Evenement $evenement) {
        $sql = "UPDATE evenement SET 
                    ...
                    date = :date,
                    lieu = :lieu,
                    idorganisateur = :idorganisateur , nbplace= :nbplace
