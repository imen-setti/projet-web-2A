...
if (!$reclamation) {
  echo "Réclamation non trouvée avec l'ID: " . $id;
...
<head>
  ...
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/349ee9c857.js"
    crossorigin="anonymous"></script>
  <link href="back-office/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle"
    href="back-office//assets/css/corporate-ui-dashboard.css?v=1.0.0"
    rel="stylesheet" />
</head>
            ...
            <div
              ...
              <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                ...
                <g id="dashboard" stroke="none" stroke-width="1" fill="none"
                  fill-rule="evenodd">
                  <g id="template" transform="translate(12.000000, 12.000000)"
        ...
        <nav aria-label="breadcrumb">
          <ol
            ...
            <li class="breadcrumb-item text-sm text-dark active"
              aria-current="page">Réclamation</li>
          </ol>
          <h6 class="font-weight-bold mb-0">Détails de la Réclamation</h6>
          <ul class="list-group">
            <li
              class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
              <div class="d-flex flex-column">
                <h6 class="mb-3 text-sm"> <?= $reclamation["id"]; ?> </h6>
                <span class="mb-2 text-xs">ID du reclamation : <span
                    class="text-dark font-weight-bold ms-sm-2">
                    <?= $reclamation["id"]; ?>
                  </span></span>
                <span class="mb-2 text-xs">Email : <span
                    class="text-dark ms-sm-2 font-weight-bold">
                    <?= $reclamation["email"]; ?></span></span>
                <span class="mb-2 text-xs">Sujet : <span
                    class="text-dark ms-sm-2 font-weight-bold">
                    <?= $reclamation["sujet"]; ?></span></span>
                <span class="mb-2 text-xs">Description: <span
                    class="text-dark font-weight-bold ms-sm-2">
                    <?= $reclamation["descrip"]; ?>
                  </span></span>
                <span class="mb-2 text-xs">Date de reclamation : <span
                    class="text-dark ms-sm-2 font-weight-bold">
                    <?= $reclamation["daterec"]; ?></span></span>
                <span class="mb-2 text-xs">Status : <span
                    class="text-dark ms-sm-2 font-weight-bold">
                    <?= $reclamation["status"]; ?></span></span>

              </div>
            </li>
            <button class="btn btn-outline-primary btn-sm mb-0"> <a
                href="liste.php"> Retour
                à la liste </a></button>
          </ul>
        </nav>
