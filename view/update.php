...
if (
    ...
    $reclamationC->updateReclamation($reclamation, $_GET['id']);
    header('Location: liste.php'); // Rediriger après mise à jour
}
?>
...
<head>
  ...
  <link href="back-office/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="back-office//assets/css/corporate-ui-dashboard.css?v=1.0.0" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="card h-200">
                    <div class="card-header pb-10 p-30">
                        <div class="row">
                                ...
                                <?php
                                if (isset($_GET['id'])) {
                                    $oldreclamation = $reclamationC->showReclamation($_GET['id']);
                                    ?>
                                </div>
                                                ...
                                                <span class="text-xs">
                                                    <td>
                                                        <input type="text" id="email" name="email"
                                                            value="<?php echo $oldreclamation['email'] ?>" />
                                                    </td>
                                                </span>
                                            </tr>
                                        </div>
                                                ...
                                                <span class="text-xs">
                                                    <td>
                                                        <input type="text" id="sujet" name="sujet"
                                                            value="<?php echo $oldreclamation['sujet'] ?>" />
                                                    </td>
                                                </span>
                                            </tr>
                                        </div>
                                                ...
                                                <span class="text-xs">
                                                    <td>
                                                        <input type="text" id="descrip" name="descrip"
                                                            value="<?php echo $oldreclamation['descrip'] ?>" />
                                                    </td>
                                                </span>
                                            </tr>
                                        </div>
                                ...
                                <ul class="list-group">
                                    <li
                                        ...
                                        <div class="d-flex flex-column">
                                            <tr>
                                                <h6 class="mb-1 text-dark font-weight-bold text-sm">
                                                    <td><label for="daterec">Date reclamation:</label></td>
                                                </h6>
                                                <span class="text-xs">
                                                    <td>
                                                        <input type="date" id="daterec" name="daterec"
                                                            value="<?php echo $oldreclamation['daterec'] ?>" />
                                                    </td>
                                                </span>
                                            </tr>
                                        </div>
    ...
    <select id="status" name="status">
        <option value="En attente" <?php if ($oldreclamation['status'] == 'En attente') echo 'selected'; ?>>En attente</option>
        <option value="En cours" <?php if ($oldreclamation['status'] == 'En cours') echo 'selected'; ?>>En cours</option>
        <option value="Résolue" <?php if ($oldreclamation['status'] == 'Résolue') echo 'selected'; ?>>Résolue</option>
        <option value="Fermée" <?php if ($oldreclamation['status'] == 'Fermée') echo 'selected'; ?>>Fermée</option>
        <option value="Rejetée" <?php if ($oldreclamation['status'] == 'Rejetée') echo 'selected'; ?>>Rejetée</option>
        <option value="Transférée" <?php if ($oldreclamation['status'] == 'Transférée') echo 'selected'; ?>>Transférée</option>
    </select>
</td>
