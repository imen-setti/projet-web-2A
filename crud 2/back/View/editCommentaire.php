...
if (!isset($_GET['id'])) {
    header("Location: listeCommentaire.php?error=ID du commentaire manquant.");
    exit();
}

$id_commentaire = $_GET['id'];
$commentaire = Commentaire::getCommentaireById($id_commentaire);
$date_creation = $commentaire['date_creation'];  

$date_creation = substr($date_creation, 0, 10);
if (!$commentaire) {
    header("Location: listeCommentaire.php?error=Commentaire introuvable.");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!preg_match('/^\d+$/', $id_blog)) {
        $errors['id_blog'] = "L'identifiant du blog doit être un nombre.";
    }
    ...
    if (empty($errors)) {
        Commentaire::modifierCommentaire($id_commentaire, $id_user, $id_blog, $contenu, $date_creation);
...
<div class="container mt-5">
  <div class="card shadow-lg">
    <div class="card-header bg-gradient-dark text-white d-flex justify-content-between align-items-center">
      <h5 class="text-white text-capitalize m-0">Modifier le Commentaire</h5>
      <a href="listeCommentaire.php" class="btn btn-sm btn-light text-dark font-weight-bold">← Retour</a>
    </div>
    <div class="card-body">
    <form method="post">
  <div class="mb-3">
    <label class="form-label">ID User :</label>
    <input type="text" name="id_user" value="<?= htmlspecialchars($commentaire['id_user']) ?>" class="">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="id_blog" value="<?= htmlspecialchars($commentaire['id_blog']) ?>" class="">
    <?php if (!empty($errors['id_blog'])): ?>
      <div class="text-danger"><?= $errors['id_blog'] ?></div>
    <?php endif; ?>
  </div>

  <div class="mb-3">
    <label class="form-label">Date de création :</label>
    <input type="date" name="date_creation" value="<?= htmlspecialchars($date_creation) ?>" class="">
  ...
  <div class="mb-3">
    ...
    <textarea name="contenu" rows="5" class=""><?= htmlspecialchars($commentaire['contenu']) ?></textarea>
